            ...
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
                    <div className="md:col-span-2">
                        <div className="flex items-center mb-4">
                            <span className="text-2xl font-bold text-blue-400">Research</span>
                            <span className="text-2xl font-bold text-white">Assistant</span>
                        </div>
                        <p className="text-gray-300 mb-6">Making research easier and more efficient for academics, scientists, and knowledge workers.</p>
                        <div className="flex space-x-4">
                            ...
                            <a href="#" className="text-gray-400 hover:text-white">
                                ...
                                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-1.366-.028-3.12-1.903-3.12-1.906 0-2.196 1.483-2.196 3.016v5.708h-3v-11h2.905v1.328h.04c.29-.55 1.006-1.132 2.07-1.132 2.214 0 2.624 1.457 2.624 3.35v7.454z" />
                                </svg>
                            </a>
                            <a href="#" className="text-gray-400 hover:text-white">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><Link to="/support" className="text-gray-300 hover:text-white">Contact</Link></li>
                        </ul>
                    </div>
                    <div className="md:col-span-1">
                        <h3 className="text-lg font-semibold mb-4">Legal</h3>
                        <ul className="space-y-3">
                            <li><Link to="/privacy-policy" className="text-gray-300 hover:text-white">Privacy</Link></li>
                ...
                <div className="mt-12 pt-8 border-t border-gray-700">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-300">&copy; {new Date().getFullYear()} Research Assistant. All rights reserved.</p>
