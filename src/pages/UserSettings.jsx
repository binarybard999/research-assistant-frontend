    ...
    return (        <div className="bg-gray-50">
            <div className="max-w-7xl mx-auto pt-5">
                <div className="px-4 sm:px-6 lg:px-8">
                    ...
                    </div>                    <div className="flex flex-col lg:flex-row gap-8">                        {/* Sidebar Navigation */}
                        <div className="lg:w-64 flex-shrink-0 lg:sticky lg:top-8">
                                ...
                                <nav className="flex flex-col">
                                    {sections.map((section) => (
                                        <button
                                            ...
                                            className={`flex items-center justify-between px-4 py-3 text-left transition-colors ${activeSection === section.id
                                        ...
                                        >
                                            ...
                                            <ChevronRight
                                                className={`h-4 w-4 transition-transform ${activeSection === section.id ? 'transform rotate-90 text-blue-500' : 'text-gray-400'
                                                    }`}
                                            />
                                        </button>
                                    ))}
                    ...
                    <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-lg mt-4">
                        <div className="px-4 sm:px-6 py-4">
                            <div className="flex items-center justify-end space-x-4">
                                {saveStatus && (
                                    <div className={`flex items-center rounded-md px-4 py-2 text-sm ${saveStatus.includes('Error')
